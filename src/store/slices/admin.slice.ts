...
import {
  ...
  CreatePlanDTO,
  UpdatePlanDTO,
} from "@/types/entities/plan.types";
...
export const approveClient = createAsyncThunk(
  ...
  async (id: string, { rejectWithValue }) => {
    try {
      ...
      return rejectWithValue(
        error.response?.data?.message || "Failed to approve client",
      );
    }
  },
);
...
export const rejectClient = createAsyncThunk(
  ...
  async (id: string, { rejectWithValue }) => {
    try {
      ...
      return rejectWithValue(
        error.response?.data?.message || "Failed to reject client",
      );
    }
  },
);
...
export const reactivateClient = createAsyncThunk(
  ...
  async (id: string, { rejectWithValue }) => {
    try {
      ...
      return rejectWithValue(
        error.response?.data?.message || "Failed to reactivate client",
      );
    }
  },
);
...
export const fetchClientAnalytics = createAsyncThunk(
  ...
  async (id: string, { rejectWithValue }) => {
    try {
      ...
      return rejectWithValue(
        error.response?.data?.message || "Failed to fetch client analytics",
      );
    }
  },
);
...
export const fetchClientsByPlan = createAsyncThunk(
  ...
  async (planId: string, { rejectWithValue }) => {
    try {
      ...
      return rejectWithValue(
        error.response?.data?.message || "Failed to fetch plan clients",
      );
    }
  },
);
...
export const updatePlan = createAsyncThunk(
  "admin/updatePlan",
  async (
    { id, data }: { id: string; data: UpdatePlanDTO },
    { rejectWithValue },
  ) => {
    try {
...
const adminSlice = createSlice({
  ...
  reducers: {
    ...
    updateCustomField: (
      state,
      action: PayloadAction<{ index: number; field: CustomFieldDefinition }>,
    ) => {
  ...
  extraReducers: (builder) => {
    ...
    builder
      ...
      .addCase(
        ...
        (state, action: PayloadAction<ClientWithStats[]>) => {
    ...
    builder
      ...
      .addCase(
        ...
        (state, action: PayloadAction<ClientDetails>) => {
          state.clientLoading = false;
    ...
    builder
     ...
     .addCase(
        ...
        (state, action: PayloadAction<Client>) => {
          ...
          // 1. Update the client in the main list
          ...
          // 2. Update selectedClient (ClientWithStats)
          if (
          ...
          // 3. ✅ THE MISSING PIECE — Update selectedClientDetails (ClientDetails)
          //    This is what ClientInfoCard reads from via the `client` prop.
          if (
            state.selectedClientDetails &&
            state.selectedClientDetails.id === updatedClient.id
          ) {
            // Resolve the full plan object from the plans list if planId changed,
            // otherwise keep the existing nested plan object intact.
            const resolvedPlan =
              updatedClient.planId &&
              updatedClient.planId !== state.selectedClientDetails.planId
                ? (state.plans.find((p) => p.id === updatedClient.planId) ??
                  state.selectedClientDetails.plan)
                : state.selectedClientDetails.plan;
    ...
    builder
      ...
      .addCase(
        fetchClientAnalytics.fulfilled,
        (state, action: PayloadAction<ClientAnalytics>) => {
          state.clientLoading = false;
...
export const selectAdminInitialized = (state: { admin: AdminState }) =>
  state.admin.adminInitialized;
export const selectAdminById = (id: string) => (state: { admin: AdminState }) =>
  state.admin.admins.find((admin) => admin.id === id);

// Client selectors
export const selectClients = (state: { admin: AdminState }) =>
  state.admin.clients;
export const selectPendingClients = (state: { admin: AdminState }) =>
  state.admin.pendingClients;
export const selectSelectedClient = (state: { admin: AdminState }) =>
  state.admin.selectedClient;
export const selectSelectedClientDetails = (state: { admin: AdminState }) =>
  state.admin.selectedClientDetails;
export const selectClientAnalytics = (state: { admin: AdminState }) =>
  state.admin.clientAnalytics;
export const selectClientLoading = (state: { admin: AdminState }) =>
  state.admin.clientLoading;
export const selectClientError = (state: { admin: AdminState }) =>
  state.admin.clientError;
export const selectClientInitialized = (state: { admin: AdminState }) =>
  state.admin.clientInitialized;
export const selectClientById =
  (id: string) => (state: { admin: AdminState }) =>
    state.admin.clients.find((client) => client.id === id);

// Plan selectors
export const selectPlans = (state: { admin: AdminState }) => state.admin.plans;
export const selectSelectedPlan = (state: { admin: AdminState }) =>
  state.admin.selectedPlan;
export const selectPlanClients = (state: { admin: AdminState }) =>
  state.admin.planClients;
export const selectPlanLoading = (state: { admin: AdminState }) =>
  state.admin.planLoading;
export const selectPlanError = (state: { admin: AdminState }) =>
  state.admin.planError;
export const selectPlanInitialized = (state: { admin: AdminState }) =>
  state.admin.planInitialized;
...
export const selectCustomFieldsBuilder = (state: { admin: AdminState }) =>
  state.admin.customFieldsBuilder;
export const selectUseDefaultFields = (state: { admin: AdminState }) =>
  state.admin.useDefaultFields;
export const selectCustomFieldsBuilderCount = (state: { admin: AdminState }) =>
  state.admin.customFieldsBuilder.length;
