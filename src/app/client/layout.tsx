  ...
  return (
    <div className="min-h-screen bg-slate-100 dark:bg-slate-950 transition-colors duration-300">
      ...
      <ClientHeader
        ...
        onMenuClick={() => setMobileMenuOpen(true)} // Fix: Ensure it opens correctly
      />
        ...
        <div className="p-6">
          <div
            className={cn(
              ...
              'min-h-[calc(100vh-7rem)] overflow-hidden transition-colors'
            )}
          >
      ...
      {mobileMenuOpen && (
        <>
          ...
          <div className="fixed inset-y-0 left-0 z-50 w-64 md:hidden animate-in slide-in-from-left duration-300">
            {/* Added missing props to mobile sidebar */}
            <ClientSidebar 
              collapsed={false} 
