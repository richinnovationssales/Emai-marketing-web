...
export function TemplateForm({ initialData, isEditMode = false }: TemplateFormProps) {
  ...
  async function onSubmit(data: TemplateFormValues) {
    try {
      if (isEditMode && initialData) {
        await dispatch(updateTemplate({ id: initialData.id, data })).unwrap();
      ...
      <CardContent>
        <Form {...form}>
          <form onSubmit={form.handleSubmit(onSubmit)} className="space-y-8">
            ...
            {/* HTML Upload — plain label, no FormField needed */}
            <div className="space-y-2">
              ...
              {/* Show validation error for content field */}
...
//         toast.success('Template updated successfully');
//         router.push('/client/templates'); // ← only addition
//       } else {
